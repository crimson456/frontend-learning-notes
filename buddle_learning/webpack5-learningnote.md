...
- output字段: 打包出口
  ...
  - uniqueName 全局环境下为防止多个webpack运行时冲突所使用的唯一名称？？？
...
- resolveLoader字段：和resolve字段相同，但只用于解析 webpack的loader包？？？
...
- webpack's Watch Mode 不会刷新浏览器
- webpack-dev-server 将服务挂载在 8080 端口上
- webpack-dev-middleware 用于自定义 express 服务器
...
6. webpack-bundle-analyzer  plugin 和 CLI 工具，将bundle内容展示为树状图
  同类插件:
